...
{foreach from=$admin_list item=admin}
	...
	<tr class="opener tbl_out" onmouseout="this.className='tbl_out'" onmouseover="this.className='tbl_hover'">
		<td class="listtable_1{if $admin.ingame}_unbanned{/if}" style="border-bottom: solid 1px rgba(14,18,21,0.4)" height="16">{$admin.user|escape:'html'}</td>
		<td class="listtable_1{if $admin.ingame}_unbanned{/if}" style="border-bottom: solid 1px rgba(14,18,21,0.4)" height="16">{$admin.authid}</td>
	</tr>
	<tr align="left">
