	  		...
	  		<div class="panel">
				...
				<tr>
			        ...
			        <td class="listtable_1" >
			            ...
			            <input class="textbox" type="text" id="year" value="YY" onmouseup="$('date').checked = true" style="width: 22%;"> 
			        </td>
			  	</tr>
				<tr>
				...
				<tr>
			        ...
			        <td class="listtable_1" ><input class="textbox" type="text" id="ban_comment" value="" onmouseup="$('comment_').checked = true" style="width: 86%;"></td>
			    </tr>
				{/if}
			    <tr>
