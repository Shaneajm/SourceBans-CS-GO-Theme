...
{else}
	...
	<tr id="sid_{$server.sid}" {if $server.enabled==0}style="background-color:#eaeaea" title="Disabled"{/if}>
		<td style="border-bottom: solid 1px rgba(14,18,21,0.4)" height='16'>{$server.sid}</td>
		<td style="border-bottom: solid 1px rgba(14,18,21,0.4)" height='16' id="host_{$server.sid}"><i>Querying Server Data...</i></td>
		<td style="border-bottom: solid 1px rgba(14,18,21,0.4)" height='16' id="players_{$server.sid}">N/A</td>
		<td style="border-bottom: solid 1px rgba(14,18,21,0.4)" height='16'><img src="images/games/{$server.icon}"></td>
		<td style="border-bottom: solid 1px rgba(14,18,21,0.4)" height='16'>
